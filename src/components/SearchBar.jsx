            ...
            <div className="max-w-screen-xl mx-auto px-4">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full md:w-auto">
                        ...
                        <button
                            onClick={onAddUser}
                            className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 !text-white px-5 py-2 h-10 rounded-md font-medium text-sm w-full sm:w-auto transition border-4 border-blue-600 hover:border-blue-700"
                        >
                            <PlusOutlined />
                            Add New User
                        </button>
